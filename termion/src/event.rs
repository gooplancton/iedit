                ...
                b'A' | b'B' | b'C' | b'D' | b'F' | b'H' => {
                    ...
                    match modifier {
                        ...
                        6 => {
                            // CtrlShift Modifier
                            match c {
                                b'D' => Event::Key(Key::CtrlShiftLeft),
                                b'C' => Event::Key(Key::CtrlShiftRight),
                                b'A' => Event::Key(Key::CtrlShiftUp),
                                b'B' => Event::Key(Key::CtrlShiftDown),
                                b'H' => Event::Key(Key::CtrlShiftHome),
                                b'F' => Event::Key(Key::CtrlShiftEnd),
                                _ => return None,
                            }
                        }
                        _ => return None,
